...
env = os.environ.copy()
env["TVM_HOME"] = "/home/pace/tvm"
python_path = os.environ.get("PYTHONPATH", "")
tvm_path = "/home/pace/tvm/python"
env["PYTHONPATH"] = tvm_path + os.pathsep + python_path
# python_p = env["PYTHONPATH"]
# tvm_p = env["TVM_HOME"]
...
if __name__ == "__main__":
	...
	#sys.argv[3] represents file name
	#sys.argv[4] represents iterration number
	#sys.argv[5] represents cpu
	#sys.argv[6] represents cpu_freq
	#sys.argv[7] represents gpu_freq
...
# subprocess.Popen("sudo /usr/sbin/nvpmodel -m {}".format(sys.argv[3]),stdin=subprocess.PIPE,shell=True)
	...
	command = """python3 lib/{}""".format(sys.argv[3])
...
# sys.exit(0)
	...
	tegra_thread.start()
	t.start()
	process = subprocess.Popen(command,stdin=subprocess.PIPE,shell=True, env = env)
